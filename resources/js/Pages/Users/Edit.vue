    ...
    <div class="max-w-3xl bg-white rounded-md shadow overflow-hidden">
      <form @submit.prevent="update">
        <div class="flex flex-wrap -mb-8 -mr-6 p-8">
          ...
          <select-input v-if="auth.user.owner" v-model="form.owner" :error="form.errors.owner" class="pb-8 pr-6 w-full lg:w-1/2" label="Owner">
  ...
  data() {
    return {
      form: this.$inertia.form({
        ...
        organization: this.user.account_id,
